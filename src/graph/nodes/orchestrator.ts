...
- especialista_requerido debe ser el rol que mejor atiende la acción elegida, según estas fronteras:
  ...
  - gobernanza: la tarea trata la estructura legal/estatutaria de la empresa o cómo blindar su misión frente a la extracción de valor cortoplacista (composición y deber fiduciario del directorio, clases de acciones y derechos de voto, estructuras de holding o fideicomiso, protección ante adquisiciones hostiles o presión de inversores) — no el diseño del modelo de negocio en sí (eso es ideacion) ni el motor de crecimiento del negocio (eso es escalado), aunque la tarea surja en cualquier fase de la startup.`;
